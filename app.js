...
const elements = {
  ...
  boardDeckStack: document.getElementById("boardDeckStack"),
  boardDiscardStack: document.getElementById("boardDiscardStack"),
  goldRace: document.getElementById("goldRace"),
  goldRacePlayer: document.getElementById("goldRacePlayer"),
  goldRaceOpponent: document.getElementById("goldRaceOpponent"),
  feedbackCaption: document.getElementById("feedbackCaption"),
  turnReplayPanel: document.getElementById("turnReplayPanel"),
  turnReplayCards: document.getElementById("turnReplayCards"),
  turnReplayMeta: document.getElementById("turnReplayMeta"),
  turnReplayClose: document.getElementById("turnReplayClose"),
  archiveInspectOverlay: document.getElementById("archiveInspectOverlay"),
  archiveInspectTitle: document.getElementById("archiveInspectTitle"),
  archiveInspectMeta: document.getElementById("archiveInspectMeta"),
  archiveInspectCards: document.getElementById("archiveInspectCards"),
  archiveInspectClose: document.getElementById("archiveInspectClose"),
  feedbackLayer: document.getElementById("feedbackLayer"),
  deckZone: document.getElementById("deckZone"),
  discardZone: document.getElementById("discardZone"),
  archiveZone: document.getElementById("archiveZone"),
  activeZone: document.getElementById("activeZone"),
  handZone: document.getElementById("handZone"),
  deckAnchor: document.getElementById("deckAnchor"),
  handAnchor: document.getElementById("handAnchor"),
  activeAnchor: document.getElementById("activeAnchor"),
  archiveAnchor: document.getElementById("archiveAnchor"),
  discardAnchor: document.getElementById("discardAnchor"),
  ...
  openTradesModal: document.getElementById("openTradesModal"),
  closeTradesModal: document.getElementById("closeTradesModal"),
  tradeBronze: document.getElementById("tradeBronze"),
  tradeSilver: document.getElementById("tradeSilver"),
  tradeProspector: document.getElementById("tradeProspector"),
  tradeAssayer: document.getElementById("tradeAssayer"),
  tradeSmelter: document.getElementById("tradeSmelter"),
  tradeRefiner: document.getElementById("tradeRefiner"),
  ...
  tradePearl: document.getElementById("tradePearl"),
  tradeObsidian: document.getElementById("tradeObsidian"),
  tradeAmethyst: document.getElementById("tradeAmethyst"),
  tradeAsh: document.getElementById("tradeAsh"),
  tradeEmber: document.getElementById("tradeEmber"),
  ...
  formatMystic: document.getElementById("formatMystic"),
  formatFoundry: document.getElementById("formatFoundry"),
  cpuFormatOverlay: document.getElementById("cpuFormatOverlay"),
  cpuFormatCore: document.getElementById("cpuFormatCore"),
  cpuFormatExpanded: document.getElementById("cpuFormatExpanded"),
  cpuFormatAncient: document.getElementById("cpuFormatAncient"),
  cpuFormatMystic: document.getElementById("cpuFormatMystic"),
  cpuFormatFoundry: document.getElementById("cpuFormatFoundry"),
  cpuFormatRandom: document.getElementById("cpuFormatRandom"),
  ...
  hostFormatMystic: document.getElementById("hostFormatMystic"),
  hostFormatFoundry: document.getElementById("hostFormatFoundry"),
  ...
  efficiencyOverlay: document.getElementById("efficiencyOverlay"),
  efficiencyMessage: document.getElementById("efficiencyMessage"),
  efficiencyOptions: document.getElementById("efficiencyOptions"),
  efficiencyConfirm: document.getElementById("efficiencyConfirm"),
  efficiencyCancel: document.getElementById("efficiencyCancel"),
  ...
  archiveTutorMessage: document.getElementById("archiveTutorMessage"),
