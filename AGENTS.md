...
## Coding Documentation update policy

update "code-docs.md" automatically whenever there are significant changes in code.

## Rules Documentation update policy

update "FIVE_STAR_CARDS_RULES.md" automatically whenever we introduce new cards/rules/mechanics/expansions
